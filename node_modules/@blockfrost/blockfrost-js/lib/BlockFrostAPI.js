...
class BlockFrostAPI {
    constructor(options) {
        ...
        * nutlinkAddressTicker
         ...
         *
         */
        this.script = scripts_1.script;
        /**
         *
         */
        this.scriptJson = scripts_1.scriptJson;
        /**
         *
         */
        this.scriptCbor = scripts_1.scriptCbor;
        /**
         *
         */
        this.scriptDatum = scripts_1.scriptDatum;
        /**
         ...
         *
         */
        this.scriptRedeemers = scripts_1.scriptRedeemers;
        /**
         * txs
         *
         * @param hash
